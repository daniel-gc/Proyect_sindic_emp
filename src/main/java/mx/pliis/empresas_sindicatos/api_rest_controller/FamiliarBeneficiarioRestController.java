...
import mx.pliis.empresas_sindicatos.negocio.servicios.familiarbeneficiario.FamiliarBeneficiarioService;
...
public class FamiliarBeneficiarioRestController {
	...
	@GetMapping("/todos")
	public ResponseEntity<List<FamiliarBeneficiarioDTO>> getFamiliaresBeneficiario(@RequestParam("idEmpleado") Integer idEmpleado) {

		try {
			var dtoList = this.familiarBeneficiarioService.getFamiliaresBeneficiario(idEmpleado);
